...
enum FUNCTION_TYPES {
    ...
    MICROBENCHMARK_WRAM_BANDWIDTH, // 1
    MICROBENCHMARK_OPS, // 2
    MICROBENCHMARK_HASH, // 3
    DPU_FUNC_LOCAL_HASH_PARTITIONING, // 4
    DPU_FUNC_GLOBAL_HASH_PARTITIONING, // 5
    DPU_FUNC_PHJ_BUILD_HASH_TABLE_LINEAR_PROBE, // 6
    DPU_FUNC_PHJ_PROBE_HASH_TABLE, // 7
    DPU_FUNC_NPHJ_BUILD_HASH_TABLE, // 8
    DPU_FUNC_NPHJ_PROBE_HASH_TABLE, // 9
    DPU_FUNC_PACKETWISE_GLOBAL_HASH_PARTITIONING, // 10
    DPU_FUNC_PACKETWISE_LOCAL_HASH_PARTITIONING, // 11
    DPU_FUNC_PACKETWISE_PHJ_BUILD_HASH_TABLE, // 12
    DPU_FUNC_PHJ_PROBE_HASH_TABLE_INNER_LINEAR_PROBE, // 13
    DPU_FUNC_MPSM_JOIN_PARTITIONING, // 14
    DPU_FUNC_MPSM_JOIN_PROBE, // 15
    DPU_FUNC_NESTED_LOOP_JOIN, // 16
    DPU_FUNC_MPSM_JOIN_SORT, // 17
    DPU_FUNC_MPSM_JOIN_RADIX_SORT, // 18
    DPU_FUNC_MPSM_JOIN_MERGE_SORT, // 19
    DPU_FUNC_MPSM_JOIN_QUICK_SORT, // 20
    DPU_FUNC_MPSM_JOIN_PROBE_ALL, // 21
    DPU_FUNC_GLB_PARTITION_COUNT, // 22
    DPU_FUNC_GLB_PARTITION_PACKET, // 23
