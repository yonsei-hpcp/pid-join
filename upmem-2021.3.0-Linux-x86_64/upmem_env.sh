...
echo "Enter UPMEM_HOME directory (default /home/chaemin/upmem-2021.3.0-Linux-x86_64): "
read upmem_home_dir
if [ "${upmem_home_dir}" = "" ]; then
    export UPMEM_HOME="/home/chaemin/upmem-2021.3.0-Linux-x86_64" #directory of UPMEM SDK. Copy only necessary modified .so files built inside the repo for now - Comment
else
